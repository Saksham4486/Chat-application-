...
public class FileTransferClient {
    ...
    public void start() throws IOException
    {
        ...
        while(true)
        {
            ...
            if (input.equalsIgnoreCase("RESTORE")) {
                JFileChooser fileChooser = new JFileChooser("."); // Opens in current project folder
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    System.out.println("Restoring from: " + path);
                    this.restoreManager = new RestoreManager(path);
                    
                    System.out.println("Choose format (txt/json): ");
                    String format = scanner.nextLine();
                    
                    if (format.equalsIgnoreCase("txt")) {
                        this.restoreManager.restoreFromTxt();
                    } else {
                        this.restoreManager.restoreFromJson();
                    }
                    System.out.println("Restore Complete! Use 'HISTORY' to view.");
                }
            }
